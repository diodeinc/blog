...
<iframe
  ...
  height="500"
  width="450"
  style={{ borderRadius: '16px', maxWidth: '100%', display: 'block', margin: '1.5rem auto' }}
  src="https://platform.twitter.com/embed/Tweet.html?id=2063013638286475759&theme=dark"
></iframe>
...
![Consolidated EE Review output from Diode's reviewer on a sample ADIN1110 design](/media/hardware-review/bugs.png)
*A sample reviewer output: findings sorted by severity, with citations back to the schematic.*
